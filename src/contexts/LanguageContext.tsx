...
const translations = {
  fr: {
    ...
    messageSentDescription: 'Nous vous recontacterons dans les plus brefs délais.',
    firstName: 'Prénom',
    lastName: 'Nom',
    email: 'Email',
  ...
  en: {
    ...
    demoSubmittedDescription: 'Our teams will get back to you quickly to propose a time slot.',
    messageSent: 'Message sent!',
    messageSentDescription: 'We will get back to you as soon as possible.',
